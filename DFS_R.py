    ...
    def ModeloDFSR(self):
        ...
        while True:
            ...
            if len(nodosConectados)!=0:
                ...
                nnN=nCSh[0] #El primer valor del vector aleatorizado se toma como segundo nodo destino
...
#el=p.NodosConectados()
#print(el)
#w=p.AleatorizarNodos(el)
#print(p.nuevoNodoFuente(w))
#p.ModeloDFSR()
